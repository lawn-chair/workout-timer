---
name: ui-expert
description: UI components expert - handles React components, theming, and auth UI. Use for tasks involving auth components, workout UI components, theming, PWA components, or app layout.
